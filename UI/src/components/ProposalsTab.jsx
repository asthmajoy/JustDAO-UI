                    ...
                    <div className="mt-4 border-t pt-4">
                      ...
                      {proposal.type === PROPOSAL_TYPES.GENERAL && (
                        <div className="mt-2 text-xs bg-gray-50 p-4 rounded">
                          ...
                          <p className="mt-2"><span className="font-medium">Call Data:</span></p>
                      ...
                      {(proposal.type === PROPOSAL_TYPES.WITHDRAWAL || 
                        ...
                        <div className="mt-2 text-xs bg-gray-50 p-4 rounded">
                          ...
                          <p className="mt-2"><span className="font-medium">Amount:</span> {formatBigNumber(proposal.amount)}</p>
                        </div>
                      )}
                      ...
                      {proposal.type === PROPOSAL_TYPES.EXTERNAL_ERC20_TRANSFER && (
                        <div className="mt-2 text-xs bg-gray-50 p-4 rounded">
                          <p><span className="font-medium">Recipient:</span> {formatAddress(proposal.recipient)}</p>
                          <p className="mt-2"><span className="font-medium">Token:</span> {formatAddress(proposal.token)}</p>
                          <p className="mt-2"><span className="font-medium">Amount:</span> {formatBigNumber(proposal.amount)}</p>
                        </div>
                      )}
